...
| S1-DONATION-POLICY | Donation controls | Create donation acknowledgment policy. | GovernanceAI / SecretarialAI | Open | Commander approval before operational use. | Draft policy and acknowledgment templates. |
| S1-DONOR-RECEIPTS | Donation controls | Send donor receipts from verified source records after Commander approval. | SecretarialAI / GovernanceAI | Open | Send gate + verified donor/payment/source data. | Build receipt workflow: draft → approve → send → verify → archive. |
...
| S1-GRANT-SUBMISSION | Grants | Submit approved grants and archive verification evidence. | GovernanceAI / SecretarialAI / S-6 as needed | Open | Commander must approve the specific grant/submission and credential use. | Build grant workflow: draft → review → approve → submit → verify receipt/confirmation → archive. |
