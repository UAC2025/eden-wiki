...
| S1-CERT-HARNESS | S-1 certification | Build parent-agent certification harness for GovernanceAI, SecretarialAI, TaskAI, ProgramsAI. | EDEN / S-1 Officer / Loop Integrity Inspector | Certified-local | No SOTA claim before external-boundary pass. | Parent-agent harness now certified locally: [[S1-Parent-Agent-Certification-Harness-2026-07-04]]. |
| S1-GRANT-SUBMISSION | Grants | Search/score/write/QC/rewrite/submit approved grants and archive verification evidence. | GovernanceAI / SecretarialAI / S-6 as needed | Active-loop | Commander must approve the specific grant/submission before S-1 submits. | Grants loop standard and scorecard created: [[Governance/Grants/S1-Grants-Loop-Standard-2026-07-03]], [[Governance/Grants/Grant-Opportunity-Scorecard-2026-07-03]]. |
| S1-PROGRAMS-OUTPUT | ProgramsAI | Produce program/volunteer/veteran-ag pipeline packet. | ProgramsAI | Live-output | PII handling; no booking confirmations. | Pipeline packet created: [[Programs/ProgramsAI-Pipeline-Packet-2026-07-04]]. |
