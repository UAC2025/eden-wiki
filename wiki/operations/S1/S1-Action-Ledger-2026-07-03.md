...
| S1-DONATION-POLICY | Donation controls | Create donation acknowledgment policy. | GovernanceAI / SecretarialAI | Open | Review before external use. | Draft policy and acknowledgment templates. |
