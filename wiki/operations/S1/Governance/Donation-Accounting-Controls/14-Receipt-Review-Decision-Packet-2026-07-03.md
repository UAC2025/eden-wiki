---
title: Receipt Review Decision Packet 2026-07-03
type: accounting-review-packet
created: 2026-07-03
status: review-decision-candidate
entity_scope: [UAC, TNR]
---

# Receipt Review Decision Packet — 2026-07-03

## BLUF
S-1 classified **29** receipt attachment rows into verified candidates, exclusions, amount-review rows, and Commander-review rows. These are accounting review decisions, not tax conclusions.
...
|---|---|---|---|---|---|---|
| `19f28b56c00edf3a` | Fwd: Your receipt from Nous Research Inc. #2318-0117 | Invoice-EO6GGHDX-0003.pdf | UAC | software_ai | 50.00 | single_amount_known_entity |
...
## Needs Commander/entity review
| Message ID | Subject | File | Entity | Category | Amount candidates | Decision reason |
|---|---|---|---|---|---|---|
| `19e1737ca3f38aea` | Fwd: Your receipt from Anthropic, PBC #2771-5987-0288 | Invoice-ZVCGN1CH-0017.pdf | unknown_review_required | software_ai | 26.50; 25.00; 1.50 | unknown_entity |
| `19e1737ca3f38aea` | Fwd: Your receipt from Anthropic, PBC #2771-5987-0288 | Receipt-2771-5987-0288.pdf | unknown_review_required | software_ai | 26.50; 25.00; 1.50 | unknown_entity |
| `19e173796437ac86` | Fwd: Your receipt from Anthropic, PBC #2771-5987-0288 | Invoice-ZVCGN1CH-0017.pdf | unknown_review_required | software_ai | 26.50; 25.00; 1.50 | unknown_entity |
| `19e173796437ac86` | Fwd: Your receipt from Anthropic, PBC #2771-5987-0288 | Receipt-2771-5987-0288.pdf | unknown_review_required | software_ai | 26.50; 25.00; 1.50 | unknown_entity |
| `19e17374a4070e51` | Fwd: Your receipt from Anthropic, PBC #2989-4202-3281 | Invoice-ZVCGN1CH-0018.pdf | unknown_review_required | software_ai | 53.00; 50.00; 3.00 | unknown_entity |
| `19e17374a4070e51` | Fwd: Your receipt from Anthropic, PBC #2989-4202-3281 | Receipt-2989-4202-3281.pdf | unknown_review_required | software_ai | 53.00; 50.00; 3.00 | unknown_entity |
| `19df0eb3b9b25d03` | Fwd: Your Tractor Supply Receipt | Customer_E_Receipt_2146_36_1065.pdf | unknown_review_required | equipment_hardware |  | unknown_entity |
| `19df0ea8d3ef9f5e` | Fwd: Your receipt from Anthropic, PBC #2884-5493-9091 | Invoice-ZVCGN1CH-0016.pdf | unknown_review_required | software_ai | 26.50; 25.00; 1.50 | unknown_entity |
| `19df0ea8d3ef9f5e` | Fwd: Your receipt from Anthropic, PBC #2884-5493-9091 | Receipt-2884-5493-9091.pdf | unknown_review_required | software_ai | 26.50; 25.00; 1.50 | unknown_entity |
| `19df0a24cecbd82f` | Fwd: Your Tractor Supply Receipt | Customer_E_Receipt_2146_36_1065.pdf | unknown_review_required | equipment_hardware |  | unknown_entity |
| `19c4fb946a80a5c3` | Fwd: Your receipt from Anthropic, PBC #2157-3235-7979 | Invoice-ZVCGN1CH-0003.pdf | unknown_review_required | software_ai | 26.50; 25.00; 1.50 | unknown_entity |
| `19c4fb946a80a5c3` | Fwd: Your receipt from Anthropic, PBC #2157-3235-7979 | Receipt-2157-3235-7979.pdf | unknown_review_required | software_ai | 26.50; 25.00; 1.50 | unknown_entity |

## Next controls
- Use only `verified_candidate` rows for auto totals.
- Excluded grant/application rows should move to Grants/Programs review, not accounting totals.
- Amount-review rows require reading the PDF line items or Commander/accountant selection of the correct total.
- Commander/entity review rows require UAC/TNR assignment before any totals.
