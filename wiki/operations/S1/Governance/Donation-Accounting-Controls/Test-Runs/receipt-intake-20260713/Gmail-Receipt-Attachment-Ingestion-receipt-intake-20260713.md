...
## BLUF
S-1 downloaded and extracted attachments/body evidence for **24 Gmail messages** matching receipt/invoice/bill/order attachment search. Register rows created: **35**. This is evidence extraction only; no tax treatment conclusions.

- Query: `has:attachment {receipt invoice statement} after:2026/01/01`
- Evidence folder: `/persist/eden/hermes/workspace/eden-wiki/wiki/operations/S1/Governance/Donation-Accounting-Controls/Test-Runs/receipt-intake-20260713/Evidence`
- CSV register: `/persist/eden/hermes/workspace/eden-wiki/wiki/operations/S1/Governance/Donation-Accounting-Controls/Test-Runs/receipt-intake-20260713/receipt_attachment_register_receipt-intake-20260713.csv`

## Register
| Message ID | Subject | Attachment | Entity | Category | Amount candidates | Review |
|---|---|---|---|---|---|---|
| `19f43bafc1cd8ac5` | Fwd: Your receipt from Nous Research Inc. #2391-9585 | Invoice-EO6GGHDX-0005.pdf | UAC | software_ai | 50.00 | no |
| `19f43bafc1cd8ac5` | Fwd: Your receipt from Nous Research Inc. #2391-9585 | Receipt-2391-9585.pdf | UAC | software_ai | 50.00 | no |
| `19f3db2e224d0623` | Fwd: Your receipt from Nous Research Inc. #2965-5272 | Invoice-EO6GGHDX-0004.pdf | UAC | software_ai | 50.00 | no |
| `19f3db2e224d0623` | Fwd: Your receipt from Nous Research Inc. #2965-5272 | Receipt-2965-5272.pdf | UAC | software_ai | 50.00 | no |
...
| `19f246595de4083d` | Fwd: Heller's Gas - Back Mountain - Statement | Statement_2118487.pdf | UAC | utilities |  | yes |
...
| `19e1737edb913a54` | Fwd: Heller's Gas - Back Mountain - Statement | Statement_2118487.pdf | UAC | utilities |  | yes |
...
| `19df4ccfde80d6a1` | Fwd: Heller's Gas - Back Mountain - Statement | Statement_2118487.pdf | UAC | utilities |  | yes |
| `19df0ed34dc0f4a6` | Fwd: TNR 2025 Tax Receipt | Statement_2118487.pdf | TNR | utilities |  | yes |
| `19df0eca607f87c1` | Fwd: Heller's Gas - Back Mountain - Invoice | Invoice EA452E49-BE6D-4414-B9BD-9560D75372DD. | UAC | utilities |  | yes |
...
| `19c4e494104edc16` | EDEN Grant Draft: Farmer Veteran Fellowship Fund — Review Required | Farmer Veteran Fellowship Fund - Urban Ark Co | UAC | tax_filing |  | yes |
| `19bd928cfb00b3a5` | TNR 2025 Tax Receipt | Statement_2118487.pdf | TNR | utilities |  | yes |
